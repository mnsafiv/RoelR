...
public class MapValueExploreImpl extends MapValue {

    public MapValueExploreImpl(int coordinate, int weight, String value, Set<String> bonusKeys, Set<MapValueIconDecorate> iconCoordinates) {
        super(coordinate, value, bonusKeys, iconCoordinates);
        coordinateProperties = new CoordinatePropertiesImpl(coordinate);
    }
