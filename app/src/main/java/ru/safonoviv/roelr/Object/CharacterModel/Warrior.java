...
public class Warrior extends CharacterPrototype {
    ...
    public Warrior(String key, int icon_id,AttackType attackType,  ArmorType armorType, JobType jobType, Set<CharacterSkill> skills, TierType tierType, Stats baseStats, Stats increaseStats) {
