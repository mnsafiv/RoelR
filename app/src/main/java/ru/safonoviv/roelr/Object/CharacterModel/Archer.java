...
public class Archer extends CharacterPrototype {
    ...
    public Archer(String key,int icon_id, AttackType attackType,ArmorType armorType, JobType jobType, Set<CharacterSkill> skills, TierType tierType, Stats baseStats, Stats increaseStats) {
