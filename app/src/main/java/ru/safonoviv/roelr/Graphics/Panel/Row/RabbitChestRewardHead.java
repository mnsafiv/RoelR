...
public class RabbitChestRewardHead extends RowStatusPanel {
    private StatusModelItem statusModelItemRabbit;
    public RabbitChestRewardHead(Context context, StatusModelItem statusModelItem, Paint paintBorder, Paint paintText, int groupId) {
        super(context, groupId,paintBorder, paintText, DefaultValue.rabbitChest.ROW_SIZE_HEAD);
